...
//			xinv.push( (y1*z2-z1*y2)/det,-(y0*z2-z0*y2)/det, (y0*z1-z0*y1)/det);
//			yinv.push(-(x1*z2-z1*x2)/det, (x0*z2-z0*x2)/det,-(x0*z1-z0*x1)/det);
//			zinv.push( (x1*y2-y1*x2)/det,-(x0*y2-y0*x2)/det, (x0*y1-y0*x1)/det);
...
//		public function get voxx():Number{return (x-xrow[3])/xrow[0];}
//		public function get voxy():Number{return (y-yrow[3])/yrow[1];}
//		public function get voxz():Number{return (z-zrow[3])/zrow[2];}
